<div class="col-12 grid-margin stretch-card">
    <div class="card">
            <div class="card-body">
                <h4 class="card-title">Form Input Data - Sejarah</h4>
                        <div class="table-responsive">
                        <div align="right"><a class="btn btn-dark btn-rounded btn-fw" href="{{route('sejarah_b.create')}}"><i class="icon icon-plus mr-2"></i>Input Data</a></div>
                        </div>
                            <hr>
                            <div class="table-responsive">
                                <table id="t_sejarah" class="table table-bordered table-condensed table-striped">
                                    <thead>
                                        <tr bgcolor="#c7c6c1">
                                            <th width="50"><b>#ID</th>
                                            <th width="200"><b>Image path</th>
                                            <th width="200"><b>Description</th>
        ...
        var table = $('#t_sejarah').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    return data ? data.substring(0, 200) + '...' : '';
                }
                },
                {
                    data: 'action',
